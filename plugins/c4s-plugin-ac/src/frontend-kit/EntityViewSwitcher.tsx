 ...
 *
 * `preview` joined in 0.2.28 for `ui-view`'s mockup document; `ac` has no such
 * view and advertises the default pair. The name is kept in the union because
 * this file is vendored kit, and a copy that quietly narrowed the type would
 * diverge from the one it was copied from for no reason.
 */
