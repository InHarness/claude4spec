...
} from '../../../src/server/services/plugin-subagents.js';
import { manifest as acPlugin } from '../src/manifest.js';
import { acAuditSubagent as sub } from '../src/subagents/ac-audit.js';
