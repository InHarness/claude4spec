...
- An item that came back with \`truncated: true\` lost its body, and in exchange carries \`edges\` — the outgoing references of the WHOLE section: \`sectionRefs\` (anchors), \`entityEmbeds\` (type + slug), \`pageLinks\` (rootId + path).
